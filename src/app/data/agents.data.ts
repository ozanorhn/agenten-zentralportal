...
export const AGENTS: AgentMeta[] = [
  ...
  },
  {
    ...
    description: 'Nimmt eine Produkt-URL oder Bild-URL entgegen, sendet JSON an den Webhook und liefert den generierten Produkttext direkt zurück.',
    icon: 'imagesmode',
    category: 'Content',
    badgeLabel: 'LIVE',
    badgeVariant: 'primary',
    ...
    inputLabel: 'Produkt-URL oder Bild-URL',
