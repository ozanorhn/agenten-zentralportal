...
export const AGENTS: AgentMeta[] = [
  ...
  },
  {
    ...
    description: 'Nimmt eine Produkt-URL oder ein Bild entgegen und liefert den generierten Produkttext direkt zurück.',
    icon: 'imagesmode',
    category: 'Content',
    badgeLabel: 'LIVE',
    badgeVariant: 'primary',
    ...
    tip: 'Mit einer optionalen Beschreibung fuer Material, Zielgruppe oder Varianten wird der Produkttext meist deutlich praeziser.',
  ...
  },
  {
    ...
    description: 'Nimmt eine CSV-Datei entgegen, schickt sie an den Webhook und liefert SEO-basierte Produktbeschreibungen als CSV-Ergebnis zurueck.',
    icon: 'table_chart',
    category: 'Content',
    badgeLabel: 'LIVE',
    badgeVariant: 'primary',
    ...
    tip: 'Lade deine Produktliste als CSV hoch. Der Agent sendet die Datei direkt an n8n und liefert dir die angereicherten SEO-Texte als neue CSV zurueck.',
  ...
  },
  {
    ...
    description: 'Dupliziert den SEO/GEO Analyse Assistenten, sendet dieselben Formulardaten aber direkt an den NoLLM-Webhook und zeigt die strukturierte Analyse im Portal.',
    icon: 'forum',
    category: 'SEO',
    badgeLabel: 'LIVE',
    badgeVariant: 'primary',
    ...
    tip: 'Nutze diese Variante, wenn du denselben SEO/GEO Formular-Flow gegen den NoLLM-Webhook pruefen willst.',
    inputLabel: 'URL',
    inputPlaceholder: 'z.B. eom.de/agency/seo',
  },
  {
    ...
    description: 'Nimmt genau eine URL entgegen, sendet sie an den alternativen n8n-Webhook und zeigt den zurueckgegebenen Markdown-Report auf einer eigenen Seite an.',
    icon: 'description',
    category: 'SEO',
    badgeLabel: 'LIVE',
    badgeVariant: 'primary',
    ...
    tip: 'Gib die vollstaendige Ziel-URL an. Der Agent sendet nur diese URL an den alternativen Webhook und zeigt dir danach direkt den Markdown-Report.',
    inputLabel: 'URL',
